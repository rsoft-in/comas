    ...
    <div class="col-sm col-md-6 col-lg-4">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <p class="card-text"><?= $page_count ?> Pages</p>
    ...
    <div class="col-sm col-md-6 col-lg-4">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <p class="card-text"><?= $post_count ?> Posts</p>
    ...
    <div class="col-sm col-md-6 col-lg-4">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <p class="card-text"><?= $user_count ?> Users</p>
    ...
    <div class="col-sm col-md-6 col-lg-4">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <p class="card-text"><?= $comment_count ?> Unpublished Comments</p>
                <a href="<?= base_url() . '/' . index_page() ?>/admin/posts" class="btn btn-primary">Open</a>
            </div>
        </div>
    </div>
